...
function addEdit(kind){
   ...
   //传给后台 type      得到代码str
   var tempUrl =  "http://localhost:1337/Edit-Configs?edit_name="+ type;
    var editcode = $.ajax({url:tempUrl,async:false});
    var resp = eval(editcode.responseText);
   var str = "<div class='edit-container'>字体内容：<input type = 'text' class='edit-input-fontvalue' value='文本'> </div>"
  $(".edit").html(str);
